...
/**
 * FractalGUI makes the buttons and sliders.
...
public class FractalGUI extends JPanel 
{
    ...
    private void reset()
    {
        ...
        ///////////////////////////////////////////////////////
        height = 173;
        FractalTriangle.p2projection = 0.5;
        FractalTriangle.offset = 0.5;
        FractalTriangle.sizeRatio = 0.5;
    ...
    private void makeScene()
    {
        ...
        {
            Point p2 = top.
                getPointOnNormalAt( FractalTriangle.p2projection, h );
     ...
     * @param buttonPanel is the button panel. 
     */
    ...
    public class SizeListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            ///////////////////////////////////////////////////////
            int sizeSliderValue = _sizeSlider.getValue();
            
            double sizesliderdub = (double) sizeSliderValue;
            //System.out.println( sizesliderdub );
            double percentage = sizesliderdub / 100;
            if( sizesliderdub > 5 )
            {
                FractalTriangle.sizeRatio = percentage;
                makeScene();
            }
    ...
    public class OffsetListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            ///////////////////////////////////////////////////////
            int offsetvalue = _offsetSlider.getValue();
            double offsetdub = (double) offsetvalue;
            double percentage = offsetdub / 100;
            FractalTriangle.offset = percentage;
            makeScene();
    ...
    public class ProjectionListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            ///////////////////////////////////////////////////////
            int projection = _projectionSlider.getValue();
            double projdub = (double) projection;
            double percentage = projdub / 100;
            FractalTriangle.p2projection = percentage;
            makeScene();
        }
    }
    ...
    public class InitialHeightListener implements ChangeListener
    {
        //------------------- stateChanged -----------------------------
        /**
         * stateChanged method for height.
         * @param ev is the statechanged.
         */
        public void stateChanged( ChangeEvent ev )
        {
            ...
            ///////////////////////////////////////////////////////
            int heightint = _heightSlider.getValue();
            height = heightint;
            makeScene();
    ...
    private class FillListener implements ActionListener
    {
        /** actionPerformed method.
          * @param ev is the action performed.
          */
    ...
    private class SideListener implements ActionListener
    {
        /** 
         * actionPerformed method.
         * @param ev is the actionperformed.
         */
        public void actionPerformed( ActionEvent ev )
        {
