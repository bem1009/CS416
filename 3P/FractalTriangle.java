...
public class FractalTriangle 
{
     ...
     * @param depth is the depth level.
     * @param tri is the triangle.
    ...
    public FractalTriangle( int depth, ATriangle tri, int height )
    {
        ...
        if( depth > 1 && height > 7 )
        {
            ...
            _children[ 0 ] = 
                new FractalTriangle( this.makeTriangle( points
            ...
            _children[ 1 ] = new 
                FractalTriangle( this.makeTriangle( 
            ...
            _children[ 2 ] = new 
                FractalTriangle( this.makeTriangle( points
                                                                        [ 2 ],
     ...
     * @param tri is a triangle.
     * @param parent is a parent.
     * @param depth is the depth.
     * @param height is the height.
     */
    private FractalTriangle ( ATriangle tri, 
                             FractalTriangle parent, 
     ...
     * @param p0 is a point.
     * @param p1 is a point.
     * @return ATriangle is a triangle
     */
