...
public class Game extends JPanel
{
    ...
    private boolean playPyramidCard( Card picked )
    {
        ...
        {            
            Card.Rank rank = picked.getRank();
            Card card = _discards.top();
            int diff = Math.abs( rank.ordinal() 
    ...
    //--------------------------canPlay-------------------------------
    /**
     * playable determines if a card can be playable this turn.
     * 
     * 
     ...
     * Play a card.
     * 
     * @param picked Card     The played card.
     * @return boolean        True if a play occurs, false otherwise.
     */
    ...
    public void autoPlayAll()
    {
        ...
        {
            System.out.println( _pyramidCards.size()
                                   + " cards left in the Pyramid" );
        }
        if( !_drawPile.empty() && _pyramidCards.isEmpty() )
        {
            System.out.println( _drawPile.size()
