...
public class FractalTriangle 
{
   ...
   public static  int      minHeight   = 7;
   private java.awt.Polygon   _poly; // min height of p2 for further
   ...
   private FractalTriangle[] _children;
   ...
   public FractalTriangle( int depth, ATriangle tri, int height )
   {
      ...
      if( depth > 1 && height > 7 )
      {
         ...
         _children = new FractalTriangle[3];
         Point[] points = _tri.getPoints();
          
         _children[0] = new FractalTriangle( this.makeTriangle( points[0], points[1] ) , this, depth-1 ,
                 this.makeTriangle( points[0], points[1] ).getHeight() );

         _children[1] = new FractalTriangle( this.makeTriangle( points[1], points[2] ) , this, depth-1 ,
                 this.makeTriangle( points[1], points[2] ).getHeight() );
         
         _children[2] = new FractalTriangle( this.makeTriangle( points[2], points[0] ) , this, depth-1 ,
                 this.makeTriangle( points[2], points[0] ).getHeight() );
